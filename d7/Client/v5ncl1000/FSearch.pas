...
uses Fbl, FExchange, FBottom, filepgkclass;
...
begin
    ...
    Left := 100;
    Top := 200;
    pgkBmp.getBmp('Search.bmp', A2form.FImageSurface);
...
begin
    ...
    cInputString.rSelectedList := ''; // 아직 몬스터와 지명추가안됨
    ...
    Frmfbl.SocketAddData(n, @cInputString);
