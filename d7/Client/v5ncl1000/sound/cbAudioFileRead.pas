...
begin
    ...
    t := FDuration;
    SCheck(FAMMultiMediaStream.GetDuration(t));
    FDuration := t;
...
begin
    ...
    t1 := FLastReadingStartTime;
    t2 := FLastReadingEndTime;
    SCheck(FAudioStreamSample.GetSampleTimes(t1,
        t2, Tmp));
    FLastReadingEndTime := t2;
    FLastReadingStartTime := t1;
