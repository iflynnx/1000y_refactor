...
begin
    ...
    CheckBoxCHANGECharName1.Checked := LgRecord.Charinfo[0].boCHANGECharName;
    CheckBoxCHANGECharName2.Checked := LgRecord.Charinfo[1].boCHANGECharName;
    CheckBoxCHANGECharName3.Checked := LgRecord.Charinfo[2].boCHANGECharName;
    CheckBoxCHANGECharName4.Checked := LgRecord.Charinfo[3].boCHANGECharName;
    CheckBoxCHANGECharName5.Checked := LgRecord.Charinfo[4].boCHANGECharName;
...
begin
    Edit_find_PrimaryKey.Text := trim(Edit_find_PrimaryKey.Text);
    fresult :=  LoginDBAdapter.Update(Edit_find_PrimaryKey.Text, @LgRecord) ;
...
begin
    ...
    LgRecord.Charinfo[0].boCHANGECharName := CheckBoxCHANGECharName1.Checked;
    LgRecord.Charinfo[1].boCHANGECharName := CheckBoxCHANGECharName2.Checked;
    LgRecord.Charinfo[2].boCHANGECharName := CheckBoxCHANGECharName3.Checked;
    LgRecord.Charinfo[3].boCHANGECharName := CheckBoxCHANGECharName4.Checked;
    LgRecord.Charinfo[4].boCHANGECharName := CheckBoxCHANGECharName5.Checked;
...
begin
    ...
    r := LoginDBAdapter.Insert(Edit_find_PrimaryKey.Text, @tempLgRecord);
    case r of
...
begin
    ...
    begin
        ...
        r := LoginDBAdapter.Insert(Edit_find_PrimaryKey.Text + inttostr(i), @tempLgRecord);
        case r of
            DB_ERR_DUPLICATE: ShowMessage('失败！数据存在。');
            DB_OK: ;                                                            // ShowMessage('写入数据成功。');
        else ShowMessage('错误写入数据失败(其他错误)!');
