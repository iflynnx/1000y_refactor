        ...
        LG_UPDATE:
            begin
                ...
                begin
                    ...
                    if nCode = DB_OK then
                    begin
                        frmMain.AddLog(format('更新成功 %s[%s,%s,%s,%s,%s]', [KeyValue,RecordData.CharInfo[0].CharName,RecordData.CharInfo[1].CharName,RecordData.CharInfo[2].CharName,RecordData.CharInfo[3].CharName,RecordData.CharInfo[4].CharName ]));
                        //更新 成功 也发完整数据
                        AddSendData(aPacket^.RequestID, aPacket^.RequestMsg, nCode, @RecordData, SizeOf(TLGRecord));
                    end else
                    begin
