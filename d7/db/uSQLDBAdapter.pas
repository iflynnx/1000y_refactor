...
uses
    Windows, SysUtils, DB, ADODB, DefType, AUtil32, uPackets, uEmaildata, uCreaSQL, uConnector;
...
type
    ...
    public
        constructor Create(atemp:TADOConnection);
    ...
    begin
        ...
        begin
            ...
            begin
                ...
                Dummy := COPY(FQuerysub.FieldByName('rDummy').AsString, 1, 66);
...
begin
    ...
    try
        FADOCommand.CommandText := SqlStr;
        FADOCommand.Execute;
...
begin
    ...
    try
        ...
        begin
            //   UserItemDataInsert(aDBRecord.PrimaryKey, UpperCase('WearItem'), i, aDBRecord.WearItemArr[i]);
            SqlStr := TUserItemDataToUPdateSQL(aDBRecord.PrimaryKey, UpperCase('WearItem'), i, @aDBRecord.WearItemArr[i]);
            FADOCommand.CommandText := SqlStr;
            FADOCommand.Execute;
        end;
        //2，FashionableDressArr:array[0..(8) - 1] of TDBItemData; //时装
        ...
        begin
            //  UserItemDataInsert(aDBRecord.PrimaryKey, UpperCase('FashionableDress'), i, aDBRecord.FashionableDressArr[i]);
            SqlStr := TUserItemDataToUPdateSQL(aDBRecord.PrimaryKey, UpperCase('FashionableDress'), i, @aDBRecord.FashionableDressArr[i]);
            FADOCommand.CommandText := SqlStr;
            FADOCommand.Execute;
        end;
        //3，HaveItemArr:array[0..30 - 1] of TDBItemData; // 物品栏物品 默认为30个格子
        ...
        begin
            // UserItemDataInsert(aDBRecord.PrimaryKey, UpperCase('HaveItem'), i, aDBRecord.HaveItemArr[i]);
            SqlStr := TUserItemDataToUPdateSQL(aDBRecord.PrimaryKey, UpperCase('HaveItem'), i, @aDBRecord.HaveItemArr[i]);
            FADOCommand.CommandText := SqlStr;
            FADOCommand.Execute;
        end;
        //4，ItemLog       data:array[0..10 * 4 - 1] of TItemLogData;//仓库
        ...
        begin
            //  UserItemDataInsert(aDBRecord.PrimaryKey, UpperCase('ItemLog'), i, aDBRecord.ItemLog.data[i]);
            SqlStr := TUserItemDataToUPdateSQL(aDBRecord.PrimaryKey, UpperCase('ItemLog'), i, @aDBRecord.ItemLog.data[i]);
            FADOCommand.CommandText := SqlStr;
            FADOCommand.Execute;
        end;
        ////////////////////////////////////////////////////////////////////////////////
        ...
        begin
            // UserMagicDataInsert(aDBRecord.PrimaryKey, UpperCase('BasicMagic'), i, aDBRecord.BasicMagicArr[i]);
            SqlStr := TUserBMagicDataToUPdateSQL(aDBRecord.PrimaryKey, UpperCase('BasicMagic'), i, @aDBRecord.BasicMagicArr[i]);
            FADOCommand.CommandText := SqlStr;
            FADOCommand.Execute;
        end;
        SqlStr := '';
        ...
        begin
            // UserMagicDataInsert(aDBRecord.PrimaryKey, UpperCase('BasicRiseMagic'), i, aDBRecord.BasicRiseMagicArr[i]);
            SqlStr := TUserBMagicDataToUPdateSQL(aDBRecord.PrimaryKey, UpperCase('BasicRiseMagic'), i, @aDBRecord.BasicRiseMagicArr[i]);
            FADOCommand.CommandText := SqlStr;
            FADOCommand.Execute;
        end;
        //3，HaveMagicArr:array[0..30 - 1] of TDBMagicData; //一层 30个
        ...
        begin
            // UserMagicDataInsert(aDBRecord.PrimaryKey, UpperCase('HaveMagic'), i, aDBRecord.HaveMagicArr[i]);
            SqlStr := TUserBMagicDataToUPdateSQL(aDBRecord.PrimaryKey, UpperCase('HaveMagic'), i, @aDBRecord.HaveMagicArr[i]);
            FADOCommand.CommandText := SqlStr;
            FADOCommand.Execute;
        end;
        // 4，HaveRiseMagicArr:array[0..30 - 1] of TDBHaveRiseMagicData; //新 二层30个
        ...
        begin
            // UserMagicDataInsert(aDBRecord.PrimaryKey, UpperCase('HaveRiseMagic'), i, aDBRecord.HaveRiseMagicArr[i]);
            SqlStr := TUserBMagicDataToUPdateSQL(aDBRecord.PrimaryKey, UpperCase('HaveRiseMagic'), i, @aDBRecord.HaveRiseMagicArr[i]);
            FADOCommand.CommandText := SqlStr;
            FADOCommand.Execute;
        end;
        //5，HaveMysteryMagicArr:array[0..30 - 1] of TDBHaveMysteryMagicData; //新 掌风武功 30个
        ...
        begin
            //UserMagicDataInsert(aDBRecord.PrimaryKey, UpperCase('HaveMysteryMagic'), i, aDBRecord.HaveMysteryMagicArr[i]);
            SqlStr := TUserBMagicDataToUPdateSQL(aDBRecord.PrimaryKey, UpperCase('HaveMysteryMagic'), i, @aDBRecord.HaveMysteryMagicArr[i]);
            FADOCommand.CommandText := SqlStr;
            FADOCommand.Execute;
        end;
        //写数据库
...
begin
    ...
    ////////////////////////////////////////////////////////////////////////////////
  //  UserdataUpdate(aDBRecord^);
    SqlStr := SqlStr + UserdataToUPdateSQL(aDBRecord^);
    ////////////////////////////////////////////////////////////////////////////////
    //                                3，物品类型
    ////////////////////////////////////////////////////////////////////////////////
    //1，WearItemArr:array[0..(8) - 1] of TDBItemData; //穿戴
    ...
    for i := 0 to high(aDBRecord.WearItemArr) do
    begin
        SqlStr := SqlStr + TUserItemDataToUPdateSQL(aDBRecord.PrimaryKey, UpperCase('WearItem'), i, @aDBRecord.WearItemArr[i]);
    end;

    //2，FashionableDressArr:array[0..(8) - 1] of TDBItemData; //时装
    for i := 0 to high(aDBRecord.FashionableDressArr) do
    begin
        SqlStr := SqlStr + TUserItemDataToUPdateSQL(aDBRecord.PrimaryKey, UpperCase('FashionableDress'), i, @aDBRecord.FashionableDressArr[i]);
    end;
    //3，HaveItemArr:array[0..30 - 1] of TDBItemData; // 物品栏物品 默认为30个格子
    for i := 0 to high(aDBRecord.HaveItemArr) do
    begin
        SqlStr := SqlStr + TUserItemDataToUPdateSQL(aDBRecord.PrimaryKey, UpperCase('HaveItem'), i, @aDBRecord.HaveItemArr[i]);
    end;
    //4，ItemLog       data:array[0..10 * 4 - 1] of TItemLogData;//仓库

    for i := 0 to high(aDBRecord.ItemLog.data) do
    begin
        SqlStr := SqlStr + TUserItemDataToUPdateSQL(aDBRecord.PrimaryKey, UpperCase('ItemLog'), i, @aDBRecord.ItemLog.data[i]);
    end;
    ////////////////////////////////////////////////////////////////////////////////
    //                                3，武功类型
    ////////////////////////////////////////////////////////////////////////////////
    ...
    for i := 0 to high(aDBRecord.BasicMagicArr) do
    begin
        SqlStr := SqlStr + TUserBMagicDataToUPdateSQL(aDBRecord.PrimaryKey, UpperCase('BasicMagic'), i, @aDBRecord.BasicMagicArr[i]);
    end;
    //2，BasicRiseMagicArr:array[0..10 - 1] of TDBBasicRiseMagicData; //新 基本二层武功 9个
    for i := 0 to high(aDBRecord.BasicRiseMagicArr) do
    begin
        SqlStr := SqlStr + TUserBMagicDataToUPdateSQL(aDBRecord.PrimaryKey, UpperCase('BasicRiseMagic'), i, @aDBRecord.BasicRiseMagicArr[i]);
    end;
    //3，HaveMagicArr:array[0..30 - 1] of TDBMagicData; //一层 30个
    for i := 0 to high(aDBRecord.HaveMagicArr) do
    begin
        SqlStr := SqlStr + TUserBMagicDataToUPdateSQL(aDBRecord.PrimaryKey, UpperCase('HaveMagic'), i, @aDBRecord.HaveMagicArr[i]);
    end;
    // 4，HaveRiseMagicArr:array[0..30 - 1] of TDBHaveRiseMagicData; //新 二层30个
    for i := 0 to high(aDBRecord.HaveRiseMagicArr) do
    begin
        SqlStr := SqlStr + TUserBMagicDataToUPdateSQL(aDBRecord.PrimaryKey, UpperCase('HaveRiseMagic'), i, @aDBRecord.HaveRiseMagicArr[i]);
    end;
    //5，HaveMysteryMagicArr:array[0..30 - 1] of TDBHaveMysteryMagicData; //新 掌风武功 30个
    for i := 0 to high(aDBRecord.HaveMysteryMagicArr) do
    begin
        SqlStr := SqlStr + TUserBMagicDataToUPdateSQL(aDBRecord.PrimaryKey, UpperCase('HaveMysteryMagic'), i, @aDBRecord.HaveMysteryMagicArr[i]);
    end;
    ////////////////////////////////////////////////////////////////////////////////
    //                                4，热键
    ////////////////////////////////////////////////////////////////////////////////
    SqlStr := SqlStr + UserKEYdataToUPdateSQL(aDBRecord^);
    ////////////////////////////////////////////////////////////////////////////////
    //                                5，任务
    ////////////////////////////////////////////////////////////////////////////////
    SqlStr := SqlStr + UserQuestdataToUPdateSQL(aDBRecord^);

    //写数据库
    FADOCommand.Connection.BeginTrans;
    try
       // FADOCommand.CommandText := SqlStr;
        FADOCommand.Execute(SqlStr);
        FADOCommand.Connection.CommitTrans;
    except
        FADOCommand.Connection.RollbackTrans;
        result := DB_ERR;
  ...
  //  UserdataUpdate(aDBRecord^);
    ...
    try
     ...
     //   FADOCommand.CommandType := cmdText;
      //  FADOCommand.Execute(SqlStr);
       // frmMain.LOGSQL.Lines.Add(SqlStr);
        FQuery.Close;
...
constructor TSQlDBAdapter.Create(atemp:TADOConnection);
begin
    ...
    FQuery.Close;
    FQuery.SQL.Clear;
    FQuerysub := TADOQuery.Create(nil);
