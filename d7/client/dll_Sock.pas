...
uses
   Windows, Graphics, ExtCtrls, log, Forms, deftype;
...
type
   ...
   TGetCompanyName   = function : Pchar;
var
   ...
   GetCompanyName : TGetCompanyName;
...
//   if NATION_VERSION <> NATION_KOREA then exit;
   ...
   if hlib < 32 then begin
      ...
      GetCompanyName := TGetCompanyName (GetProcAddress (hlib,'GetCompanyName'));
