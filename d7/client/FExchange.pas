...
uses
  ...
  StdCtrls, A2Form, ExtCtrls, deftype, cltype, AUtil32, adeftype, Charcls,
  AtzCls, uAnsTick;
...
// Add by minds 020620
procedure TFrmExchange.A2ILabel1MouseDown(Sender: TObject;
...
begin
   if (Button = mbRight) and (TControl(Sender).Hint <> '') then begin
      ...
      GrobalClick.rwindow := WINDOW_EXCHANGE;
