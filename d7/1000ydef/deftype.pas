...
// 앱鳩鏤경굶
   ...
   HAVEITEMSIZE = 50;          //膠틔으
   HAVEBasicMagicArr = 10;   //寧꿔轟츰
   HAVEBasicRiseMagicArr = 10;     // 랗꿔읫훙
   HAVEBASICMAGICSIZE = 20;
   HAVEMAGICSIZE = 50;          //寧꿔嶠묘
   HAVERISEMAGICSIZE = 50;     // 랗꿔嶠묘
   HAVEMATERIALITEMSIZE = 5;
   HAVEMARKETITEMSIZE = 10;
   HAVEMYSTERYMAGICSIZE = 50;        // 廊랬
   HAVEBESTSPECIALMAGICSIZE = 15;    //劤 힛꿔徠駕 15몸
   HAVEBESTPROTECTMAGICSIZE = 5;     // 劤 힛꿔빱竟 5몸
   HAVEBESTATTACKMAGICSIZE = 5;      // 없劤 힛꿔묑샌嶠묘 5몸
