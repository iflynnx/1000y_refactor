...
//   if StrCode2 <> StrCode then exit;
   ...
   DBSender := TPacketSender.Create ('DB_SENDER', BufferSizeS2S, Socket, false, false);
   DBReceiver := TPacketReceiver.Create ('DB_RECEIVER', BufferSizeS2C, false);
...
begin
   ...
   BattleSender := TPacketSender.Create ('Battle_SENDER', BufferSizeS2S, Socket, false, false);
   BattleReceiver := TPacketReceiver.Create ('Battle_RECEIVER', BufferSizeS2C, false);
