...
uses
  Windows, Messages, SysUtils, Classes, StdCtrls, ExtCtrls, DsgnIntf, Forms,
  Graphics, Buttons, AnsImg2, AUtil32;
...
begin
   ...
   aSour.UnLock(ddsour.lpSurface);
   aDest.UnLock(dddest.lpSurface);
end;
