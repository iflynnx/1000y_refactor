...
type
  ...
  public
    ...
    procedure RegisterFunction(const FuncName: AnsiString; MethodName: AnsiString = ''; Obj: TObject = NIL); virtual; //register function
...
//
procedure TLua.RegisterFunction(const FuncName: AnsiString; MethodName: AnsiString = ''; Obj: TObject = NIL);
var
...
begin
  ...
  CallBack.Routine.Code := Self.MethodAddress((MethodName));
