...
const
  ckcount = 40; //仓库格子40个
const
  C_NewQuestIDlistIndexMin = 1;
  C_NewQuestIDlistIndexMax = 30;
  ...
  numsay_31 = 31;
  //消息 对应 表
  cNumSayArr: array[0..31] of string = (
    ...
    '此人是GM。无法探查', //8  numsay_examineGM_no
  ...
  HAVEMAGICSIZE60 = 60;
{$IFDEF size30}
  xHAVEMAGICSIZE = 30; //20130705修改，60武功格
{$ELSE}
  xhavemagicsize = 60;
{$ENDIF}

 {//
 xHAVEMAGICSIZE30 = 60; //这里改60就是60武功格，但是需要重新建数据库user.db 20121229
 xHAVEMAGICSIZE = 60;   //20130705修改，60武功格
  //     }
  VIEWRANGEWIDTH = 13 + 4; //13; //10;    //修改可视范围  宽屏吧，如果上下都修改，容易看不到怪物
  VIEWRANGEHEIGHT = 11 + 4; //11; //8;
  ...
  ITEM_KIND_GuildAddLife = 120; //门派加血石头(门战期间可用,间隔30分钟)
  ...
  ITEM_KIND_GuildAddLife2 = 135; //门派加血石头(门战期间不可用,无间隔时间)
  ITEM_KIND_136 = 136; //强化 材料
  ITEM_KIND_137 = 137; //增加成功率 材料
  ITEM_KIND_138 = 138; //失败不降级材料
  ITEM_KIND_139 = 139; //失败不消失材料
  ITEM_KIND_140 = 140; //双倍年龄道具
  ITEM_KIND_141 = 141; //DungeonRate 成功率道具
  ...
  ITEM_Attribute_7 = 7;
  ITEM_Attribute_8 = 8;
  ITEM_Attribute_99 = 99; //可销毁物品

  
  MONTER_KIND_9 = 9; //不按照浩然拾取怪物
  ...
  ARR_CAP = 8; //* 帽子
  ARR_WEAPON = 9; //* 武器
  ARR_10_Special = 10; //戒指
  ARR_11_Special = 11; //令牌
  ARR_12_Special = 12; //天命1
  ARR_13_Special = 13; //天命2
  ...
  udpReceiverc_EmporiaInfo = 6;
  udpReceiverc_ItemUpgrade = 7;
  ...
  SM_CHARFEATURELIST = 110;
  SM_Bindmoney = 111;
  SM_NewQuest = 112;
  SM_ITEMDATA = 113;
  SM_OtherUserLifeData = 114;
  SM_OtherUserATTRIBBASE = 115;
  SM_UpdateBanList = 116;
  SM_ConfirmDialog = 117; //输入框
  SM_Complex = 118; //合成道具
  SM_ItemUpgrade = 119; //强化道具
  SM_Upload = 120; //截图
  SM_ProcBlackList = 121; //进程黑名单
  SM_CloseClient = 122; //关闭客户端
  SM_AutoAttack = 123; //反击怪物消息发送
  SM_AutoAttackUser = 124; //反击玩家消息发送
  SM_CHATITEMMESSAGENORMAL = 125;
  SM_CHATITEMMESSAGE = 126;
  SM_SAYITEMMESSAGEM = 127;
  SM_BillboardGuilds = 128;
  SM_PromptDialog = 129; //提示框
  SM_MysqlBillboard = 130;
  SM_MOTION3 = 131;
  SM_MyEffect = 132;
  SM_ADDBUFF = 133;
  SM_DELBUFF = 134;
  ...
  //合成道具
  Complex_GetItemList = 1;
  Complex_Start = 2;
  Complex_End = 3;
  Complex_Err = 4;
  Complex_Windows_close = 5; //关闭合成窗口
  Complex_showForm = 6; //显示合成窗口

  //装备强化
  ItemUpgrade_showForm = 1; //显示合成窗口
  ItemUpgrade_Windows_close = 2; //关闭合成窗口
  ItemUpgrade_Start = 3; //开始
  ItemUpgrade_ItemInfo = 4; //获取信息
  ItemUpgrade_End = 5;
  ItemUpgrade_Err = 6;
  ...
  WINDOW_Emporia = 43; //商城窗口
  WINDOW_Close_All = 44;
  WINDOW_Booth_edit = 45;
  WINDOW_Booth_user = 46;
  WINDOW_MAGICS_Rise = 47;
  WINDOW_MAGICS_Mystery = 48;
  WINDOW_ShowPassWINDOW_Clear = 49;
  WINDOW_ShowPassWINDOW_ALLOWEDIT = 50;
  WINDOW_ConfirmDialog = 51; //输入窗口
  WINDOW_Complex = 52; //合成窗口
  WINDOW_ItemUpgrade = 53; //强化窗口
  ...
  CM_SAYITEM = 77;
  CM_MSayItem = 78;
  CM_DBLCLICKSAYITEM = 79;
  CM_GETSAYITEMDATA = 80;
  CM_BillboardGuilds = 81;
  CM_GAMECHECK_RESULT = 82;
  CM_ITEMDEL = 83;
  CM_MAKEGUILDMAGIC_VIEW = 84;
  CM_SENDSAY = 85;
  CM_MysqlBillboard = 86;
  CM_ItemDiy = 87;
  CM_MAKEGUILDMAGIC_XG = 88;
    CM_GETBUFF = 89;

  NewQuest_CM_GETLIST = 0;
  NewQuest_CM_GETINFO = 1;
  NewQuest_CM_COMPLETE = 2;
  ////////////////////////////////////////////////////////////
  ...
  Billboardcharts_3h = 3;
  Billboardcharts_newTalent = 4;
  Quest_GETlist = 1;
  Quest_GET = 2;
  Quest_DEL = 3;
  Quest_listDEL = 4;
  ...
  HailFellow_del2 = 10;     
  HailFellow_Mysql_List = 11;
  HailFellow_MYSQLADD = 12;
  HailFellow_MYSQLDEL = 13;
  ...
  GUILD_sys = 20;
  GUILD_add = 21; //收人
  GUILD_del = 22; //剔除,管理踢出
  GUILD_del_i = 23; //剔除,自己退门
  ...
  GUILD_get_info = 33;
  GUILD_list_addALLYMsg = 34; //邀请同盟消息
  GUILD_list_addALLYMsgOk = 35;
  GUILD_list_addALLYMsgNo = 36;
  GUILD_get_magicinfo = 37;
  ...
  BanID = 0; //2015.11.26 在水一方
  BanIP = 1;
  BanHcode = 2;
  BanlistFile = 'Banlist.dat';
  BanID_Desc = '屏蔽帐号';
  BanIP_Desc = '屏蔽IP';
  BanHcode_Desc = '屏蔽电脑'; //<<<<<<
...
type
  TMouseInfo = record //2016.03.23 在水一方
    msg: Byte;
    mx, my: Word;
    x, y: Word;
    deg: Word;
  ...
  TBillboardchartstype = (bctnewTalent, bctPrestige, bctEnergy);
  ...
  TBillboardGuildsData = record
    rid: integer;
    rSysopname: string[32];
    rEnergy: integer;
    rCount: integer;
    rGuildName: string[20];
  end;
  pTBillboardGuildsData = ^TBillboardGuildsData;
  TMsgType = (mtNone, mtSys, mtSay, mtLeftText, mtLeftText2, mtLeftText3, mtLeftText4, mtLeftLightText, mtLeftLightText2, mtLeftLightText3, mtLeftLightText4, mtLeftBigText, mtLeftBigText2, mtLeftBigText3, mtLeftBigText4);
  //mtLeftText左边 滚动 消息
  ...
  TFeature = record
    ...
    rEffect_WEAPON_gcolor: word;
    rEffect_WEAPON_light: byte;
    rEffect_WEAPON_glight: byte;
    rEffect_WEAPON_showghost: boolean;
    rEffect_WEAPON_flickspeed: word;
    rEncKey: word;
  end;
  pTFeature = ^TFeature;
  ...
  TBasicData = record
    ...
    boNotBowHit: boolean; //是否接受远程 攻击 TRUE 不接受攻击
    MapPathID: integer;
    rbooth: boolean;
    boNotAddExp: boolean;
    ...
    master: Pointer;                    
    rboScripterHit: boolean; //是否触发攻击脚本
  end;
  ...
  THitData = record
    ...
    //2016-08-28增加
    HitMagicType: integer; //武功类型
    CurMagicDamage: integer; //武功攻击力
  end;
...
Script,MaxCount,BoNotSave,ExtJobExp,}
  ...
  //装备
    ...
    rTradeMoneyName: string[10];
    rNotHaveItem: array[0..5 - 1] of TCheckItem; //拥有该物品将无法拾取物品
  end;
  ...
  PTBuffData = ^TBuffData;
  
  TBuffDataMessage = record
    rmsg: byte;
    rid: Integer;
    rBuffData: TBuffData;
  end;
  PTBuffDataMessage = ^TBuffDataMessage;
  
  TAllBuffDataMessage = record
    rmsg: byte;
    rid: Integer;
    rstruct: Byte;
    rbuffcount: byte;
    rBuffData: array[0..99] of TBuffData;
  end;
  PTAllBuffDataMessage = ^TAllBuffDataMessage;
  ...
  TMonsterData = record
    ...
    rboScripterHit, rboUpdateTime: Boolean;
  ...
  //  rBestShortExp3: integer; //(绝世武功3级经验)
   ...
   //        rendtime: ttime;                                                        //2009 3 24 增加
    ...
    rboHit: boolean; //2015年10月17日 16:13:18增加是否允许攻击
    rboNotBowHit: boolean; //2016年3月4日 08:53:29 增加是否允许远程攻击
    rboControl: boolean;
    rxControl: integer;
    ryControl: integer;
    rKind: integer;
  ...
  //HaveItem,AttackMagic,AttackSkill,HaveMagic,RegenInterval,boBattle,boRightRemove,boEnmity
  TNpcData = record
    rName: TNameString;
    rViewName: TNameString;
    rAnimate: integer;
    ...
    rboUPdateTime: Boolean;
    //rboScripterHit: Boolean;
  end;
  PTNpcData = ^TNpcData;
  ...
  TMenuSTATE = (
    ...
    , nsUPdateitemSetting //9,升级装备
    , nsUPdateitemSettingdel //10,升级装备
    );
  ...
  TAttribData = record
    ...
    //////////////////////////////////// 转换时候得把这段去掉
    cpetname: string[50];
    cpetgrade, cpetexp, cpetmax: Int64;
    cpetmagic: string[50];
    guildPoint: Integer;
    guildName: TNameString;
    //天赋
    newTalent: integer;
    newTalentExp: integer;
    newTalentLv: Integer;
    newTalentNextLvExp: integer;
    newBone: word; //根骨
    newLeg: word; //身法
    newSavvy: word; //悟性
    newAttackPower: word; //武学

    VipUseLevel: byte; //VIP等级
    VipUseTime: Tdatetime; //VIP时间

    //双倍经验
    MagicExpMulCount: byte; //倍数
    MagicExpMulEndTime: integer; //新增倍数剩余时间 秒

    Charm: integer; //魅力
    Flower: integer; //鲜花
    Egg: integer; //鸡蛋
    AddableStatePoint: integer; //强化祝福值
    ///////////////////////////////////////////
  end;
  //任务 属性 特殊情况下的 属性
...
第8位 解锁状态    默认是1440分钟解锁,比如:狐狸骨头:1:1:0:0:0:0:2:10 ,说明该物品已经解锁10分钟.}
  ...
  TItemLogDataEx = record
    rMaxItemPage: byte;
  end;
  pTItemLogDataEx = ^TItemLogDataEx;
  TSItemLogDataEx = record
    rmsg: byte;
    rItemLogDataEx: TItemLogDataEx;
  end;
  PTSItemLogDataEx = ^TSItemLogDataEx;
  ...
  TItemLogRecord = record
    ...
    rsize: integer;
    data: array[0..ckcount - 1] of TItemLogData;
  end;
  ...
  TDBRecord_20091013 = record
    ...
    ServerId: word; // 角色所在服务器地图 0表示新手村 1表示长城以南
    x: word; // X 坐标
    y: word; // Y 坐标
    ...
    //佩带
    WearItemArr: array[0..(14) - 1] of TDBItemData_20091013; //穿戴
    FashionableDressArr: array[0..(14) - 1] of TDBItemData_20091013; //时装

    //拥有 Have
    HaveItemArr: array[0..30 - 1] of TDBItemData_20091013; // 物品栏物品 默认为30个格子

    //基本武功，分一层和二层基本
    BasicMagicArr: array[0..10 - 1] of TDBMagicData_20091013; //基本武功 一层武功
    BasicRiseMagicArr: array[0..10 - 1] of TDBMagicData_20091013; //新 基本二层武功 9个

    //一层武功和二层武功
    HaveMagicArr: array[0..60 - 1] of TDBMagicData_20091013; //一层 30个
    HaveRiseMagicArr: array[0..xHAVEMAGICSIZE - 1] of TDBMagicData_20091013; //新 二层30个

    //掌风武功
    HaveMysteryMagicArr: array[0..xHAVEMAGICSIZE - 1] of TDBMagicData_20091013; //新 掌风武功 30个
 ...
 //   HaveMaterialItemArr:array[0..5 - 1] of TDBHaveMaterialItemData; //0-4,新  身上 物品
  ...
  //  PersonArr:array[1..5 - 1] of TDBPersonData; //新 1 - 4, 陌生 人
    ...
    HaveItemQuestArr: array[0..30 - 1] of TDBItemDataQuest; //任务道具
    ...
    //////////////////////////////////// 转换时候得把这段去掉
    petname: string[50];
    petgrade, petexp, petmax: Int64;
    petmagic: string[50];
       //以下为14.11.20后新增
    guildPoint: integer; //帮派贡献
    //guildName: TNameString; //帮派名称
    lucky: integer; //气运
    newTalent: integer; //天赋点
    newTalentExp: integer; //天赋经验
    newTalentLv: integer; //天赋级别
    newBone: word; //根骨
    newLeg: word; //身法
    newSavvy: word; //悟性
    newAttackPower: word; //武学
    newBindMoney: Int64; //绑定钱币
    newQuestIDList: array[C_NewQuestIDlistIndexMin..C_NewQuestIDlistIndexMax] of byte;
  ...
  TWearItemArr = array[0..(14) - 1] of TDBItemData;
  TDBWearItemArr = array[0..5 - 1] of TWearItemArr;
  ...
  TDBRecord = record
    ...
    //一层武功和二层武功
    HaveMagicArr: array[0..xhavemagicsize - 1] of TDBMagicData; //一层 60个
    HaveRiseMagicArr: array[0..xHAVEMAGICSIZE - 1] of TDBMagicData; //新 二层60个

    //掌风武功
    HaveMysteryMagicArr: array[0..xHAVEMAGICSIZE - 1] of TDBMagicData; //新 掌风武功 60个
 ...
 //   HaveMaterialItemArr:array[0..5 - 1] of TDBHaveMaterialItemData; //0-4,新  身上 物品
  ...
  //  PersonArr:array[1..5 - 1] of TDBPersonData; //新 1 - 4, 陌生 人
    ...
    newAttackPower: word; //武学
    newBindMoney: Int64; //绑定钱币
    newQuestIDList: array[C_NewQuestIDlistIndexMin..C_NewQuestIDlistIndexMax] of byte; //新任务ID索引
    ...
    Flower: integer; //鲜花
    Egg: integer; //鸡蛋
    ComplexExp: integer; //新 合成经验
    ///////////////////////////////////////////
  end;

  PTDBRecord = ^TDBRecord;
  TDBRecordInfo = record
    name: string[20];
    used: boolean;
    feature: TFeature;
  end;
  PTDBRecordList = ^TDBRecordList;
  TDBRecordList = array[0..5 - 1] of TDBRecordInfo;
  ...
  TDBRecord_n = record
    ...
    ExtraExp, //新   额外 真气经验
      AddableStatePoint, //新   三层 真气  (暂时当强化祝福值用)
      TotalStatePoint, //新   总真气
      CurrentGrade //新
      : integer;
    ...
    //一层武功和二层武功
    HaveMagicArr: array[0..60 - 1] of TDBMagicData; //一层 30个
    HaveRiseMagicArr: array[0..xHAVEMAGICSIZE - 1] of TDBMagicData; //新 二层30个

    //掌风武功
    HaveMysteryMagicArr: array[0..xHAVEMAGICSIZE - 1] of TDBMagicData; //新 掌风武功 30个
 ...
 //   HaveMaterialItemArr:array[0..5 - 1] of TDBHaveMaterialItemData; //0-4,新  身上 物品
  ...
  TJobUpgradelData = record
    ...
    bodec, bodel: boolean;
    decRate, delRate, powerlevel, luck: integer;
    bomsg: boolean;
  end;
  PTJobUpgradelData = ^TJobUpgradelData;

  //天赋升级结构
  TTalentLevelData = record
    Lv: integer;
    Exp: integer;
    Point: integer;
  end;
  PTTalentLevelData = ^TTalentLevelData;
  ...
  TCreateGuildData = record
    ...
    rMaxEnegy, rEnegy: integer; //贡献 门派升级用
    ...
    FGuildTeam: Integer; //2015.11.09新增 门派 团队
    AllyGuild: array[0..3 - 1] of string[20]; //新增 门派 同盟
  end;
...
///////////////////////////////////
  ...
  TSShowCenterMsgEx = record
    rMsg: Byte;
    rColor: Word;
    rtype: byte; //类型
    rColorCount: Word;
    rColors: array[0..1024 - 1] of Word;
    rText: TWordString;
  end;
  PTSShowCenterMsgEx = ^TSShowCenterMsgEx;
...
5，锁}
  ...
  TSChangeFeature_Npc_MONSTER = record
    ...
    rId: LongInt;
    rFeature_npc_MONSTER: TFeature_npc_MONSTER;
    rBuffEffectCount: byte;
    rBuffEffect: array[0..99] of word;
  end;
  ...
  PTSChatItemMessage = ^TSChatItemMessage;

  TSChatItemMessageHead = record
    rmsg: byte;
    rIsHead: boolean;
    rSn: LongInt;
    rId: LongInt;
  ...
  PTSChatItemMessageHead = ^TSChatItemMessageHead;

  TSChatItemMessageM = record
    rmsg: byte;
    rFColor: word;
    rBColor: word;
    rtype: byte;
  ...
  PTSChatItemMessageM = ^TSChatItemMessageM;
  ...
  //MYSQL好友列表结构
  TSHailFellowMysqlList = record
    rmsg: byte;
    rkey: byte;
    rName: TNameString;
    rType: Integer;
  end;
  pTSHailFellowMysqlList = ^TSHailFellowMysqlList;
  ...
  TSENDUPDATEITEMTYPE = (suitHave, suitHaveNoInfo, suitWear, suitWearFd);
  ...
  TSAttribBase = record
    ...
    rCurLife, rLife, rlucky: word;
    rAdaptive, rRevival: word; //耐性 再生
    rCTalent: integer;
    rCTalentLv: integer;
    rCTalentExp: integer;
    rCTalentNextLvExp: integer;
    rCnewBone: word; //根骨
    rCnewLeg: word; //身法
    rCnewSavvy: word; //悟性
    rCnewAttackPower: word; //武学
  end;
  ...
  TSNPCItem = record
    ...
    rShape: word;
    rPrice: integer; //价格
    rTradeMoneyName: string[10]; //货币类型
  end;
  ...
  TCIdPass = record
    ...
    rPass: TNameString;
    ryid: integer;
    routip: string[16]; //2015.11.25 在水一方
    rhcode: string[100]; //<<<<<<
    rccode: string[100]; //2016.01.23 在水一方
  end;
  PTCIdPass = ^TCIdPass;
  ...
  PTCClickChatItem = ^TCClickChatItem;
  ...
  PTCTalentUpdate = ^TCTalentUpdate;
  TCQuestGet = record
    rmsg: byte;
    rkey: word;
    rqid: integer;
...
{  LG_INSERT       = 0;
  ...
  GM_BA = 9; //发送到GATE
  GM_PING = 10;
  GM_BANLIST = 11; //Banlist发送到BA
  GM_GETBANLIST = 12; //发送到TGS
  GM_THESAVED = 13; //正在保存的

  // Balance Server Message
  BM_GATEINFO = 0;
  BM_Exequatur = 1;
  BM_BANLIST = 2; //Banlist
  BM_GETBANLIST = 3;
...
type
  ...
  TNoticeData = record
    ...
    rhcode: string[100]; //<<<<<<
    rccode: string[100]; //2016.01.23 在水一方
    rMessage: string[100]; //2016.01.23 在水一方
  end;
  ...
  TWordComData2 = record
    Size: Word;
    Data: array[0..deftype_MAX_PACK_SIZE - 1 - 5] of Byte;
  end;
  pTWordInfoData = ^TWordInfoData;
  TWordInfoData = record
    rmsg: byte;
    rWordData: TDBRecordList;
  end;
  //包基本格式
  TPacketData = record
    PacketSize: Word;
  ...
  PTUploadPacketData = ^TUploadPacketData;
  ...
  pTNewQuestdata = ^TNewQuestdata;

  TSMotion3 = record
    rmsg: byte;
    rId: LongInt;
    rRenderer_color: word;
    rRenderer_gcolor: word;
    rRenderer_light: byte;
    rRenderer_glight: byte;
    rFlick_speed: word;
    rGhost_visible: Boolean;
  end;
  pTSMotion3 = ^TSMotion3;
...
var
  G_Default1024: Boolean = false;
  _test_test_mode: Boolean = false;
  _test_ghost_mode: Boolean = false;
  _test_ghost_visible: Boolean = true;
  _test_ghost_count: word = 6;
  _test_ghost_delay: word = 1000;
  _test_flick_speed: word = 50;
  _test_renderer_mode: Boolean = true;
  _test_renderer_light: Integer = 20;
  _test_ghost_light: Integer = 40;
  _test_renderer_color: word = 0;
  _test_ghost_color: word = 0;
  _test_CenterColor_Par: word = 50;
  _test_OuterColor_Par: word = 40;
  _test_InnerColor_Par: word = 100;
  _test_CenterColor_Bright: array[0..3] of word = (15,15,15,15);
  _test_CenterColor_Contrast: array[0..3] of word = (15,15,15,15);
  _test_range_color_par: array[0..3] of Word = (50,68,86,100);
  _test_range_width_par: array[0..3] of Word = (2,4,6,9);
  _test_remove_filename: string = '';
  _test_delete_mode: Boolean = false;
  _test_Saturation_Enable: Boolean = true;
  _test_LightInner_Enable: Boolean = true;
implementation
...
function strtobool(x: string): Boolean;
begin
  if x = '1' then result := True else result := False;
end;
...
procedure TItemDataToTWordComData(var Source: TItemData; var ComData:
  ...
  begin
    ...
    or (aLifeData.AttackSpeed <> 0)
      ...
      or (aLifeData.accuracy <> 0)
      or (aLifeData.HitArmor <> 0)
      or (aLifeData.HitArmor <> 0)
      then
      exit;
  ...
  begin
    ...
    if (aLifeData.HitArmor <> 0) then
      aState := aState + [_ldds_HitArmor];
    ...
    if (aLifeData.HitArmor <> 0) then
      WordComData_ADDword(ComData, aLifeData.HitArmor);
...
begin
  ...
  WordComData_ADDString(ComData, Source.rTradeMoneyName);
  ...
  case Source.rKind of
    ...
    , ITEM_KIND_WEARITEM_GUILD //60号  掉持久
      ...
      begin
        ...
        WordComData_ADDword(ComData, Source.rSmithingLevel); //等级
        //精练等级   //新 装备等级
  ...
  case Source.rKind of
    ...
    ITEM_KIND_ARROW, ITEM_KIND_FLYSWORD: //箭 //飞刀
      begin
        _addTLifeData(Source.rLifeDataBasic);
      end;
    //        ITEM_KIND_WEARITEM2                                                     //24号
  ...
  WordComData_ADDbyte(ComData, Source.rAttribute); //特殊属性
end;
...
{var
  ...
  begin
    ...
    if _ldds_hitarmor in aState then
      aLifeData.HitArmor := WordComData_GETword(ComData, i);
...
begin
  ...
  begin
    ...
    rTradeMoneyName := WordComData_getString(ComData, i);
...
//            ITEM_KIND_WEARITEM2                                                 //24号      // , ITEM_KIND_WEARITEM_29                                         //29 有头盔是29
    ...
    case rKind of
      ...
      ITEM_KIND_ARROW, ITEM_KIND_FLYSWORD: //飞刀 箭
        begin
          _getTLifeData(rLifeDataBasic);
        end;
      //ITEM_KIND_WEARITEM2                                                 //24号      //, ITEM_KIND_WEARITEM_29                                         //29 有头盔是29
    ...
    //特殊属性
    rAttribute := WordComData_getbyte(ComData, i);
...
begin
  ...
  with aitem do
  begin
    result := result + format('名称: %s', [rname]) + #13#10 + '{2} ' + #13#10;
    Result := result + format('等级: %s', [Get10000To100(rcSkillLevel)]) + #13#10 + '{2} ' + #13#10;
    if rcLifeData.AttackSpeed > 0 then
      result := result + format('速度: %d', [rcLifeData.AttackSpeed]) + #13#10 + '{2} ' + #13#10;
    if rcLifeData.recovery > 0 then
      result := result + format('恢复: %d', [rcLifeData.recovery]) + #13#10 + '{2} ' + #13#10;
    if rcLifeData.avoid > 0 then
      result := result + format('躲闪: %d', [rcLifeData.avoid]) + #13#10 + '{2} ' + #13#10;
    if rcLifeData.accuracy > 0 then
      result := result + format('命中: %d', [rcLifeData.accuracy]) + #13#10 + '{2} ' + #13#10;
    if rcLifeData.HitArmor > 0 then
      result := result + format('维持: %d', [rcLifeData.HitArmor]) + #13#10 + '{2} ' + #13#10;

    if (rcLifeData.damageBody <> 0) or (rcLifeData.damageHead <> 0) or (rcLifeData.damageArm <> 0) or (rcLifeData.damageLeg <> 0) then
      result := result + format('攻击: %d/%d/%d/%d', [rcLifeData.damageBody, rcLifeData.damageHead, rcLifeData.damageArm, rcLifeData.damageLeg]) + #13#10 + '{2} ' + #13#10;

    if (rcLifeData.armorBody <> 0) or (rcLifeData.armorHead <> 0) or (rcLifeData.armorArm <> 0) or (rcLifeData.armorLeg <> 0) then
      result := result + format('防御: %d/%d/%d/%d', [rcLifeData.armorBody, rcLifeData.armorHead, rcLifeData.armorArm, rcLifeData.armorLeg]) + #13#10 + '{2} ' + #13#10;
