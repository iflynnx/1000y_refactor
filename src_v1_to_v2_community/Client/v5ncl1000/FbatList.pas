        ...
        case PSSShowListWindow^.rType of
          ...
          2:
            begin                       // Delete
              ...
              Str := GroupStr;
              Str := GetValidStr3(Str, rdStr, ':');
              for i := 0 to A2ListBox.Count - 1 do
              begin
                Str := A2ListBox.Items[i];
                Str := GetValidStr3(Str, rdStr2, ':');
                if rdStr = rdStr2 then
                begin
...
begin
  ...
  for i := 1 to ListBoxSurface.Height div EtcAtzClass.GetEtcAtz(72).Width + 2 do
  begin
  ...
  case aBatWindowType of
    TWT_GList:
      begin
        ...
        A2ButtonOK.A2Up := EtcAtzClass.GetEtcAtz(58);
        A2ButtonOK.A2Down := EtcAtzClass.GetEtcAtz(59);
        A2ButtonCancel.A2Up := EtcAtzClass.GetEtcAtz(60);
        A2ButtonCancel.A2Down := EtcAtzClass.GetEtcAtz(61);
        A2ButtonRanking.A2Up := EtcAtzClass.GetEtcAtz(106);
        A2ButtonRanking.A2Down := EtcAtzClass.GetEtcAtz(107);
      end;
    TWT_RList:
      begin
        A2ButtonOK.Visible := TRUE;
        ...
        A2ButtonOK.A2Up := EtcAtzClass.GetEtcAtz(62);
        A2ButtonOK.A2Down := EtcAtzClass.GetEtcAtz(63);
        A2ButtonCancel.A2Up := EtcAtzClass.GetEtcAtz(60);
        A2ButtonCancel.A2Down := EtcAtzClass.GetEtcAtz(61);
        A2ButtonFight.A2Up := EtcAtzClass.GetEtcAtz(64);
        A2ButtonFight.A2Down := EtcAtzClass.GetEtcAtz(65);
        A2ButtonShow.A2Up := EtcAtzClass.GetEtcAtz(66);
        A2ButtonShow.A2Down := EtcAtzClass.GetEtcAtz(67);
      end;
    TWT_ranking:
      begin
        A2ButtonOK.Visible := TRUE;
        ...
        A2ButtonOK.A2Up := EtcAtzClass.GetEtcAtz(108);
        A2ButtonOK.A2Down := EtcAtzClass.GetEtcAtz(109);
        A2ButtonCancel.A2Up := EtcAtzClass.GetEtcAtz(60);
        A2ButtonCancel.A2Down := EtcAtzClass.GetEtcAtz(61);
        A2ButtonRanking.A2Up := EtcAtzClass.GetEtcAtz(110);
        A2ButtonRanking.A2Down := EtcAtzClass.GetEtcAtz(111);
      end;
  end;
end;
...
begin
  ...
  pgkBmp.getBmp('mubase.bmp', A2form.FImageSurface);
  ...
  begin
    A2ListBox.AddItem(format(('¾ÆÀ×ÅÛ %d'), [i]));
  end;
  BatWindowType := TWT_GList;
  SetImage(BatWindowType);
  SetListBoxImage;
  ...
  case BatWindowType of
    TWT_GList:
      begin
        ...
        Frmfbl.SocketAddData(sizeof(TCWindowConfirm), @cCWindowConfirm);
